...
int32_t     g_OllamaTopK = 0;
float       g_OllamaMinP = 0.0f;
int32_t     g_OllamaRepeatLastN = 0;
...
void LoadOllamaChatConfig()
{
    ...
    g_OllamaTopK                      = sConfigMgr->GetOption<int32_t>("OllamaBotControl.TopK", 0);
    g_OllamaMinP                      = sConfigMgr->GetOption<float>("OllamaBotControl.MinP", 0.0f);
    g_OllamaRepeatLastN               = sConfigMgr->GetOption<int32_t>("OllamaBotControl.RepeatLastN", 0);
    g_OllamaPresencePenalty           = sConfigMgr->GetOption<float>("OllamaBotControl.PresencePenalty", 0.0f);
    g_OllamaFrequencyPenalty          = sConfigMgr->GetOption<float>("OllamaBotControl.FrequencyPenalty", 0.0f);
